        ...
        <div className="px-4 pb-4">
          ...
          <div className="grid grid-cols-12 gap-2 py-4">
            <div className="relative col-span-3 sm:col-span-2">
              <div
                className={`flex h-16 w-full items-center justify-center rounded-md sm:h-28 sm:w-36 ${
              ...
              >
                <Package
                  className={`${isMobile ? 'h-8 w-8' : 'h-12 w-12'} ${statusBadge.color}`}
                />
              </div>
              ...
              <div className="flex w-full justify-end">
                <div className="flex items-center gap-1">
                  <span className="text-sm text-primary sm:text-base">
                    {formatCurrency(cardOrder.cardPoint, '')} điểm
                  </span>
                </div>
              </div>
            </div>
