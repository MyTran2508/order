                    ...
                    <div className="space-y-4">
                      <div className="flex items-center justify-between">
                        ...
                        <Badge variant="secondary">
                          {cardOrder.giftCards.length} thẻ
                        </Badge>
                      </div>
                      <div className="grid gap-4">
                        {cardOrder.giftCards.map((giftCard, index) => {
                          ...
                          return (
                            <Card
                              key={codeId}
                              className="border-2 border-dashed border-purple-200 bg-gradient-to-br from-purple-50 to-pink-50 dark:border-purple-800 dark:from-purple-950/20 dark:to-pink-950/20"
                            >
                              <CardHeader className="pb-3">
                                <div className="flex items-center justify-between">
                                  <div className="flex items-center gap-2">
              ...
              <Card>
                <CardHeader className="pb-3">
                  ...
                  >
                    ...
                    <Badge variant="secondary">
                      {cardOrder.receipients.length} người
                    </Badge>
                  </CardTitle>
                </CardHeader>
                <CardContent className="space-y-4">
